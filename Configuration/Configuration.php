...
namespace Lukaschel\PimcoreDataSaveHandlerBundle\Configuration;

use Pimcore\Extension\Bundle\PimcoreBundleManager;

class Configuration
{
    const SYSTEM_CONFIG_DIR_PATH = PIMCORE_PRIVATE_VAR . '/bundles/PimcoreDataSaveHandlerBundle';
    const SYSTEM_CONFIG_FILE_PATH = PIMCORE_PRIVATE_VAR . '/bundles/PimcoreDataSaveHandlerBundle/config.yml';
